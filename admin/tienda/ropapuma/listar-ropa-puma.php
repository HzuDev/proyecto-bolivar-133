...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg pt-24 pl-24">
    <div class=" p-4 pl-8">
        <a href="crear-ropa-puma.php" class="bg-picton-blue-500 hover:bg-picton-blue-700 text-white font-bold py-2 px-4 rounded">
            Nuevo Prenda
        </a>
    </div>
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 ">
            <tr>
                ...
                <th scope="col" class="px-6 py-3">Prod. Destacado?</th>
        ...
        <tbody>
            <?php
            $consql = "SELECT * FROM ropaPuma WHERE estado ='disponible'";
            ...
            ?>
                <tr class="bg-white border-b ">
                    ...
                    <td class="px-6 py-4">
                        <input type="checkbox" <?php echo $fila['prod_destacado'] ? 'checked' : ''; ?> disabled>
                    </td>

                    <div>
                        <td class="px-6 py-4">
                            <a href="actualizar-ropa-puma.php?cod=<?php echo $fila['codigo']; ?>" class="text-indigo-600 hover:text-indigo-900">Modificar</a>
                            <a href="borrar-ropa-puma.php?cod=<?php echo $fila['codigo']; ?>" class="text-red-600 hover:text-red-900">Eliminar</a>
                            <a href="destacar-ropa.php?cod=<?php echo $fila['codigo']; ?>" class="text-green-600 hover:text-green-900">Destacar</a>
