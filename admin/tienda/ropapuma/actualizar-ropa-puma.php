...
if (isset($_POST['Modificar'])) {
    ...
    $con_sql1 = "UPDATE ropaPuma SET etiqueta = '$var1' WHERE codigo = '$cod'";
    $con_sql2 = "UPDATE ropaPuma SET titulo = '$var2' WHERE codigo = '$cod'";
    $con_sql3 = "UPDATE ropaPuma SET talla = '$var3' WHERE codigo = '$cod'";
    $con_sql4 = "UPDATE ropaPuma SET color = '$var4' WHERE codigo = '$cod'";
    $con_sql5 = "UPDATE ropaPuma SET material = '$var5' WHERE codigo = '$cod'";
    $con_sql6 = "UPDATE ropaPuma SET precio = '$var6' WHERE codigo = '$cod'";
...
<section class="pt-16">
    ...
    <?php
    $consulta = "select * from ropaPuma where codigo = '$cod'";
    $res = mysqli_query($db, $consulta);
    while ($fila = mysqli_fetch_array($res)) {
    ?>

        <form class="max-w-md mx-auto" method="POST" action="actualizar-ropa-puma.php?cod=<?php echo $fila['codigo']; ?>">
